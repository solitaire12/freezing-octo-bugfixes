package com.org.tang.common.flatmenu;
...
public class MenuActivity extends FragmentActivity {
	...
	private Class<?> fragmentArray[];// =
										// {FragmentPage1.class,FragmentPage2.class,FragmentPage3.class,FragmentPage4.class,FragmentPage5.class};

	// 定义数组来存放按钮图片
	private int mImageViewArray[];// =
									// {R.drawable.tab_home_btn,R.drawable.tab_message_btn,R.drawable.tab_selfinfo_btn,
									// R.drawable.tab_square_btn,R.drawable.tab_more_btn};
										// use selector for batter performance
